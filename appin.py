...
def show_welcome_page():
    ...
    st.markdown('<p class="title">School of Aeronautical Engineering</p>', unsafe_allow_html=True)
    ...
    *Get started by selecting an option from the sidebar!*
    ...
    with st.expander("How to use this app"):
        ...
        """)
    video_file = open(r"appin1 and 1 more page - Personal 2 - Microsoft​ Edge 2025-03-30 11-44-28.mp4", "rb")
